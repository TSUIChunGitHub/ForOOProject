 ...
 * Date:10/4/2016
 */
public class Supervisor extends AbstractStaff{

	public Supervisor(){}
	
	public Supervisor(String staffId, String firstName, String lastName,
	...
	public void handleLeaveRequest(LeaveRequest leaveRequest) {
		...
		if(!leaveRequest.getIsApproveBySupervisor() && leaveRequest.getStatus() != leaveRequest.PENDING) {
